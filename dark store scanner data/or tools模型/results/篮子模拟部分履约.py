...
# 1. 参数区
# =========================
SCANNER_FILE = "/Users/sandmwong/Desktop/OR_tools/dark store scanner data/or tools模型/optimizer/scanner_data.csv"
ROLLING_FILE = "/Users/sandmwong/Desktop/OR_tools/dark store scanner data/or tools模型/results/rolling_results.csv"
PLAN_FILE = "/Users/sandmwong/Desktop/OR_tools/dark store scanner data/or tools模型/results/plans.csv"

OUTPUT_WINDOW_FILE = "basket_window_results.csv"
OUTPUT_SUMMARY_FILE = "basket_summary.csv"
OUTPUT_PROXY_FILE = "basket_proxy_gap.csv"
...
def simulate_one_plan(order_lines_test: pd.DataFrame,
    ...
    for order_id, grp in order_lines_test.groupby("order_id", sort=False):
        ...
        # 如果某一行不满足，是否还要扣减能满足的行？
        # 这里采用“部分履约”逻辑：能发的行照常发
        # 若你想做“整单不拆单”，可改成只有 order_full=True 才统一扣减
