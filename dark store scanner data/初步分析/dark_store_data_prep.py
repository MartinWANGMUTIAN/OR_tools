...
df_raw = pd.read_csv('/mnt/user-data/uploads/scanner_data.csv')
...
plt.close()
log("已保存: figures/data_exploration.png")
...
daily_wide.to_csv('daily_demand.csv')
weekly_wide.to_csv('weekly_demand.csv')
